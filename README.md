...
Web chat links used to understand the problem:

| # | Tool | Topic | Link |
|---|---|---|---|
| 1 | ChatGPT | BhuMe assessment understanding & approach | https://chatgpt.com/share/6a2a944d-8760-8322-86a6-1bb617efce16 |
...
```bash
python quickstart.py data/34999_malatavadi_xxx
```

```bash
python quickstart.py data/34855_vadnerbhairav_chandavad_nashik
```
